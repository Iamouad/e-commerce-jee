...
<div class="py-2">
<h2 class="text-center blockquote " >Bienvenue dans l'espace Admin de la boutique en ligne</h2>
<p class="text-center blockquote " ><button id="logout" class="btn btn-danger">Logout</button></p>
	...
	<table class="table table-hover">
		...
		<tr id="produitform" style="display: none">
			...
			<td><input type="text" id="prix" class="form-control"
				placeholder="price in euros" pattern="^\d+(\.\d{1,4})?$" required /></td>
